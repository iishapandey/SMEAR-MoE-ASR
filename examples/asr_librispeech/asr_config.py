...
class ModelConfig:
    ...
    moe_gating: bool = field(default="False", metadata={"help": "If wanted to use moe gating instead of lang_mask "})
    
    moe_routing: str = field(default="utter", metadata={
        "help": "Routing strategy for MoE. Choose from: utter, token, uniform"
    })

    tied_experts: bool = field(default="false", metadata={
        "help": "if want to tie similar experts"
    })
...
class TrainConfig:
    ...
    save_on_best_val_loss:bool = True
...
class DataConfig:
    ...
    whisper_rep_path: str = field(default="None", metadata={"help":"where whisper decoder states will be saved"})
    whisper_encoder_path: str = field(default="None", metadata={"help":"loading model for saving decoding states"})
